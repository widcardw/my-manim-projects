...
class DouPandulumLine(VGroup):
    ...
    def __init__(self, line1, line2, **kwargs):
        # line1.set_color(self.line1_color)
        # line2.set_color(self.line2_color)
        VGroup.__init__(
            self, line1, line2, **kwargs
        )

    def resetLines(self, line1, line2, **kwargs):
        newState = DouPandulumLine(line1, line2, **kwargs)
        self.become(newState)

    def get_end(self):
        return self[1].get_end()


class DouPandulumScene(Scene):
